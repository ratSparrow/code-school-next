...
const ProjectSyllabus = () => {
  ...
  return (
    <div id="projects" className="mx-2 py-0 md:py-8">
      ...
      <Slider {...projectSettings}>
        {projectSyllabus.map((project, index) => (
          <div key={index} className="py-8 md:py-16 px-2 md:px-4">
            <div className="bg-blue-50 rounded-2xl shadow-lg hover:shadow-2xl border border-blue-100 hover:border-blue-300 overflow-hidden transition-all duration-300 md:h-[700px] flex flex-col justify-between" >
              <img
